...
function create_tag_url(){
  if(window.location.href == "https://juamejiago.pythonanywhere.com/create_tag/"){
    reload_main_page()
  }else{
    window.location.replace("https://juamejiago.pythonanywhere.com/create_tag/");
  }
}

function add_tag_to_category_url() {
  if(window.location.href == "https://juamejiago.pythonanywhere.com/add_tag_to_category/"){
    reload_main_page()
  }else{
    window.location.replace("https://juamejiago.pythonanywhere.com/add_tag_to_category/");
  }
}
...
function transfer_tag_between_categories_url() {
  if(window.location.href == "https://juamejiago.pythonanywhere.com/transfer_tag_between_categories/"){
    reload_main_page()
  }else{
    window.location.replace("https://juamejiago.pythonanywhere.com/transfer_tag_between_categories/");
  }
}
...
function reload_main_page() {
  const url = "https://juamejiago.pythonanywhere.com/home";
  window.location.replace("https://juamejiago.pythonanywhere.com/home");
}